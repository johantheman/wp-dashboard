            ...
            <div class="container-fluid">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">Welcome Automation Performance</p>
                            </div>
                            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card ">
                            <div class="header">
                                <h4 class="title">YTD Volume</h4>
                                <p class="category">All segment volume</p>
                            </div>
                            <div class="content">
                                ...
                                <div class="footer">
                                    <div class="legend">
                                        ...
                                        <i class="fa fa-circle text-danger"></i> Compact
                                    </div>
                                    <hr>
                                    <div class="stats">
                    ...
                    <div class="col-md-6">
                        <div class="card ">
                            <div class="header">
                                ...
                                <p class="category">Observations</p>
                            </div>
                            <div class="content">
...
<!--end modal-->
	...
	<script type="text/javascript">
    	$(document).ready(function(){
        	...
        	$.notify({
            	icon: 'pe-7s-gift',
            	message: "Welcome to <b>DStv Automation Dashboard</b> - <b>dynamic welcome automation visualization.</b>"
